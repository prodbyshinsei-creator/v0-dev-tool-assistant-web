            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-9">
                  <svg viewBox="0 0 64 52" fill="none" className="w-full h-full">
                    <style>{`@keyframes fl2{0%,100%{transform:rotate(0deg)}50%{transform:rotate(-13deg) translateY(-4px)}}@keyframes fr2{0%,100%{transform:rotate(0deg)}50%{transform:rotate(13deg) translateY(-4px)}}@keyframes fc2{0%,100%{transform:translateY(0)}50%{transform:translateY(-5px)}}.w2l{transform-box:fill-box;transform-origin:center bottom;animation:fl2 2.4s ease-in-out infinite}.w2r{transform-box:fill-box;transform-origin:center bottom;animation:fr2 2.4s ease-in-out .1s infinite}.w2c{transform-box:fill-box;transform-origin:center bottom;animation:fc2 2.4s ease-in-out infinite}`}</style>
                    <rect className="w2l" x="4" y="14" width="38" height="26" rx="5" fill="#3b82f6" opacity="0.7"/>
                    <rect className="w2r" x="22" y="14" width="38" height="26" rx="5" fill="#22c55e" opacity="0.7"/>
                    <rect className="w2c" x="13" y="10" width="38" height="28" rx="5" fill="#f8f8f8" opacity="0.95"/>
                    <line x1="13" y1="19" x2="51" y2="19" stroke="#111" strokeWidth="4" opacity="0.12"/>
